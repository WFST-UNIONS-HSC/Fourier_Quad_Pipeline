...
inline constexpr int col_polychi2 = ccd_num_cols + LensingConfig::iid;  // PSF fit chi-square column.
inline constexpr int col_pixx = ccd_num_cols + LensingConfig::ipixx;  // Source x column.
inline constexpr int col_pixy = ccd_num_cols + LensingConfig::ipixy;  // Source y column.
inline constexpr int col_sig = ccd_num_cols + LensingConfig::isig;  // Noise sigma column.
inline constexpr int col_star = ccd_num_cols + LensingConfig::istar;  // PSF-star count column.
inline constexpr int col_peak = ccd_num_cols + LensingConfig::ipeak;  // Historical peak column.
inline constexpr int col_imax = ccd_num_cols + LensingConfig::i_imax;  // Peak x column.
inline constexpr int col_jmax = ccd_num_cols + LensingConfig::i_jmax;  // Peak y column.
inline constexpr int col_h_flux = ccd_num_cols + LensingConfig::ih_flux;  // Half-light flux column.
inline constexpr int col_h_area = ccd_num_cols + LensingConfig::ih_area;  // Source area column.
inline constexpr int col_flag = ccd_num_cols + LensingConfig::iflag;  // Quality flag column.
inline constexpr int col_PSF = ccd_num_cols + LensingConfig::iPSF;  // Local PSF size column.
inline constexpr int col_SNR_F = ccd_num_cols + LensingConfig::iSNR_F;  // Fourier SNR column.
inline constexpr int col_ra = ccd_num_cols + LensingConfig::ira;  // Source RA column.
inline constexpr int col_dec = ccd_num_cols + LensingConfig::idec;  // Source Dec column.
inline constexpr int col_gf1 = ccd_num_cols + LensingConfig::igf1;  // Field distortion g1 column.
inline constexpr int col_gf2 = ccd_num_cols + LensingConfig::igf2;  // Field distortion g2 column.
inline constexpr int col_g1 = ccd_num_cols + LensingConfig::ig1;  // Fourier_Quad g1 column.
inline constexpr int col_g2 = ccd_num_cols + LensingConfig::ig2;  // Fourier_Quad g2 column.
inline constexpr int col_de = ccd_num_cols + LensingConfig::ide;  // Shear response column.
inline constexpr int col_h1 = ccd_num_cols + LensingConfig::ih1;  // Higher-order h1 column.
inline constexpr int col_h2 = ccd_num_cols + LensingConfig::ih2;  // Higher-order h2 column.
inline constexpr int col_cos2 = ccd_num_cols + LensingConfig::icos2;  // Spin-2 cosine column.
inline constexpr int col_sin2 = ccd_num_cols + LensingConfig::isin2;  // Spin-2 sine column.
inline constexpr int col_parity = ccd_num_cols + LensingConfig::iparity;  // WCS parity column.
inline constexpr int col_chi2 = ccd_num_cols + LensingConfig::ichi2;  // Exposure chi-square column.

// Total number of columns in the catalog
inline constexpr int ICHI2 = ccd_num_cols + LensingConfig::npara;  // Total catalog row width.
