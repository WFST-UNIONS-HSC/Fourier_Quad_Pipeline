...
| `InitConfig` | `SCIENCE_ROOT`, `DQ_ROOT`, `OUTPUT_ROOT`, archive/FITS naming conventions | Paths seed `RuntimeOptions` and have CLI overrides; archive/FITS conventions are header-only and require rebuilding. |
