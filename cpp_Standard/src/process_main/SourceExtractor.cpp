...
namespace SourceExtractor {
    ...
    // Method: Consume the temporary detection catalog, jointly form each source stamp and local
    //         covariance noise power, and route all products through checked main-process writers.
    // ==========================================
